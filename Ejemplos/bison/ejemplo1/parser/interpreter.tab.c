...
#line 1361 "interpreter.tab.c"
    break;

  case 7:
#line 86 "interpreter.y"
       { std::cout << "exp --> NUMBER" << std::endl;}
#line 1367 "interpreter.tab.c"
    break;

  case 8:
#line 89 "interpreter.y"
                { std::cout << "exp --> exp '+' exp" << std::endl;}
#line 1373 "interpreter.tab.c"
    break;

  case 9:
#line 92 "interpreter.y"
                { std::cout << "exp --> exp '-' exp" << std::endl;}
#line 1379 "interpreter.tab.c"
    break;

  case 10:
#line 95 "interpreter.y"
                { std::cout << "exp --> exp '*' exp" << std::endl;}
#line 1385 "interpreter.tab.c"
    break;

  case 11:
#line 98 "interpreter.y"
                { std::cout << "exp --> exp '/' exp" << std::endl;}
#line 1391 "interpreter.tab.c"
    break;

  case 12:
#line 101 "interpreter.y"
                { std::cout << "exp --> '(' exp ')' " << std::endl;}
#line 1397 "interpreter.tab.c"
    break;


#line 1401 "interpreter.tab.c"
